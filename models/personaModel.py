...
class PersonaModel:
    ...
    def get_personas(self):
        try:
            ...
            personas = []
            sQuery = f"SELECT ci, nombres, apellidos, to_char(fechanac,'DD-MM-YYYY'), licvehicular, foto, tiposangre, hipertencion, altura, peso, direccion, user_id FROM persona ORDER BY ci ASC;"
